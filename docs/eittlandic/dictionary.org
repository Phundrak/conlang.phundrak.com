...
As a preposition, /að/ generally indicates motion or direction towards
something, or attachment to something. It can be translated as /to/,
/towards/, or /at/.
...
2. to, towards, used to indicate direction or destination
   ...
   Unlike [[file:./dictionary.md#til][til]], /að/ emphasizes on the proximity towards the goal, or in
   the case of a movement (physical or metaphorical), of an approach
   of the goal.

   Some dialects also prefer to use /að/ rather than [[file:./dictionary.md#til][til]].
...
As a preposition, /á/ indicates a position or static location on a
surface, in time, or in state. It generally triggers the accusative
for temporal uses, while it triggers the dative for any other use.
...
*** bú(a)
wv. {{{phon(bò)}}}, from ON [[https://old-norse.net/html/b.php#b%C3%BAa-A][búa]]
...
*** dýrgríp(a)
wn.f. {{{phon(ˈdø̀r.ˌɡrèp)}}}, from [[file:./dictionary.md#dyr][dýr]] and [[file:./dictionary.md#grip-a][gríp(a)]]
...
*** Frídag
sn.m. {{{phon(frèdɑɣ)}}}, from EON [[https://old-norse.net/html/f.php#frj%C3%A1dagr][fríadagr]]
...
*** frétt
sn.f. {{{phon(frèt)}}}, from ON [[https://old-norse.net/html/f.php#fr%C3%A9tt][frétt]]
...
*** fréttblað
sn.n. {{{phon(ˈfrèt.blɑð)}}}, from [[file:./dictionary.md#frett][frétt]] and [[file:./dictionary.md#blað][blað]]
...
*** fúl
adj. {{{phon(fòl)}}}, from ON [[https://old-norse.net/html/f.php#f%C3%BAll][fúll]]
...
*** gríp(a)
sv. {{{phon(ɡrèp)}}}, from [[https://old-norse.net/html/g.php#gr%C3%ADpa][grípa]]
...
*** holbú
wn.m. {{{phon(ˈhol.bò)}}}, from [[file:./dictionary.md#hol][hol]] and [[file:./dictionary.md#bu][bú]]
...
*** hvílskláð(i)
wn.n. {{{phon(ˈʍèlʃ.kˌlɛ̀ð)}}}, from [[file:./dictionary.md#hvil-a][hvíl]] and [[file:./dictionary.md#klað-i][kláð]]
...
1. cousin; the child of one’s parent’s sibling (male or female), with
...
** Í
*** í
prep. {{{phon(è)}}}, from ON [[https://old-norse.net/html/ii.php#%C3%AD][í]]

/Í/ indicates location or position inside something. When indicating a
motion, the accusative is triggered, while the accusative is used when
...
*** sjónvarphús
sn.n. {{{phon(ʃɔ̀n.βarp.hòs)}}}, from [[file:./dictionary.md#sjonvarp][sjónvarp]] and [[file:./dictionary.md#hus][hús]]
...
*** skáp
sn.m. {{{phon(ʃkɛ̀p)}}}, from ON [[https://old-norse.net/html/s.php#sk%C3%A1pr][skápr]]
...
*** stíg(a)
sv. {{{phon(ʃtèj)}}}, from ON [[https://old-norse.net/html/s.php#st%C3%ADga][stíga]]
...
*** stígukk(i)
sn.f. {{{phon(ʃtèjuxː)}}}, from [[file:./dictionary.md#stig-a][stíg(a)]] and [[file:./dictionary.md#ukkik][ukkik]]
...
*** súp
wn.f. {{{phon(sòp)}}}, from ON [[https://old-norse.net/html/s.php#s%C3%BApa2][súpa]]
...
This preposition indicates direction, purpose, or destination towards
something. It triggers the dative case.
...
1. to, towards, used to indicate direction or destination, often with
   ...
   Unlike [[file:./dictionary.md#að][að]], /til/ emphasizes more on the goal itself or the purpose of
   the action.

   Some dialects also simply prefer to use /til/ rather than [[file:./dictionary.md#að][að]].
...
*** tíð
sn.n. {{{phon(tèð)}}}, from ON [[https://old-norse.net/html/t.php#t%C3%AD%C3%B0][tíð]]
...
*** því
adv. {{{phon(θwè)}}}, from ON [[https://old-norse.net/html/th.php#%C3%BEv%C3%AD][því]]
